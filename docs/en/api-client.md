...
> [Back to contents](./README.md) · [Canonical module (`pokemon.api.ts`)](https://github.com/Vlad92msk/synapse/blob/master/packages/examples/src/examples/pokemon-advanced/pokemon.api.ts) · [Interactive sandbox](https://github.com/Vlad92msk/synapse/blob/master/packages/examples/src/examples/ApiClientExample.tsx)
