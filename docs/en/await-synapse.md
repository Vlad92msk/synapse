...
> [Back to contents](./README.md) · [Canonical module (`PokemonAdvancedExample.tsx`)](https://github.com/Vlad92msk/synapse/blob/master/packages/examples/src/examples/pokemon-advanced/PokemonAdvancedExample.tsx) · [Sandbox (Timer)](https://github.com/Vlad92msk/synapse/blob/master/packages/examples/src/examples/AwaitSynapseExample.tsx)
