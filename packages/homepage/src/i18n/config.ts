...
const resources = {
  ru: {
    translation: {
      ...
      // Homepage — лендинг (доп. ключи дизайна)
      'homepage.hero.badge': 'synapse-storage',
      'homepage.hero.heading': 'Три независимых инструмента',
      'homepage.hero.headingAccent': 'в одной библиотеке.',
      'homepage.hero.readDocs': 'Читать документацию',
      'homepage.hero.tag1': 'TypeScript-first',
      'homepage.hero.tag2': 'rxjs · react опциональны',
      'homepage.hero.tag3': 'tree-shakeable',

      'homepage.pillars.eyebrow': 'Три независимых блока',
      'homepage.pillars.heading': 'Каждый блок — отдельный модуль, который можно подключить сам по себе',
      'homepage.pillars.section': 'Раздел',

      'homepage.features.eyebrow': 'Почему Synapse',
      'homepage.features.heading': 'Гибкость без компромиссов',
      ...
      'homepage.architecture.layer2': 'Слой 2',
      'homepage.architecture.layer2Name': 'Business Logic Layer',
      'homepage.architecture.layer2Desc': 'как логика управляет состоянием',
      'homepage.architecture.more': 'Подробнее об архитектуре',

      'homepage.cta.heading': 'Возьмите только то, что нужно',
      'homepage.cta.text': 'Один пакет, три независимых инструмента. Начните с установки и подключите свой слой.',
      'homepage.cta.install': 'Установка',
      ...
      'nav.sections.overview.install': 'Установка',
      ...
      'nav.sections.react.ssr-hydration': 'SSR-гидрация',
  ...
  en: {
    translation: {
      ...
      // Homepage — landing (extra design keys)
      'homepage.hero.badge': 'synapse-storage',
      'homepage.hero.heading': 'Three independent tools',
      'homepage.hero.headingAccent': 'in a single library.',
      'homepage.hero.readDocs': 'Read the docs',
      'homepage.hero.tag1': 'TypeScript-first',
      'homepage.hero.tag2': 'rxjs · react optional',
      'homepage.hero.tag3': 'tree-shakeable',

      'homepage.pillars.eyebrow': 'Three independent blocks',
      'homepage.pillars.heading': 'Each block is a standalone module you can use on its own',
      'homepage.pillars.section': 'Section',

      'homepage.features.eyebrow': 'Why Synapse',
      'homepage.features.heading': 'Flexibility without compromise',

      'homepage.architecture.eyebrow': 'Architecture',
      'homepage.architecture.heading': 'Two layers',
      'homepage.architecture.intro':
      ...
      'homepage.architecture.layer1': 'Layer 1',
      'homepage.architecture.layer1Name': 'State Manager',
      'homepage.architecture.layer1Desc': 'where state lives',
      'homepage.architecture.layer2': 'Layer 2',
      'homepage.architecture.layer2Name': 'Business Logic Layer',
      'homepage.architecture.layer2Desc': 'how logic drives state',
      'homepage.architecture.more': 'More about the architecture',

      'homepage.cta.heading': 'Take only what you need',
      'homepage.cta.text': 'One package, three independent tools. Start with the install and plug in your layer.',
      'homepage.cta.install': 'Install',
      ...
      'nav.sections.overview.install': 'Install',
      ...
      'nav.sections.react.synapse-ctx': 'createSynapseCtx',
      'nav.sections.react.await-synapse': 'awaitSynapse',
      'nav.sections.react.ssr-hydration': 'SSR hydration',
