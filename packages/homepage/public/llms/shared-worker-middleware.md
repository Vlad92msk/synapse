<!-- source: docs/en/shared-worker-middleware.md · canonical: https://synapse-homepage.web.app/docs/shared-worker · part of https://synapse-homepage.web.app/llms-full.txt -->
