<!-- source: docs/en/custom-fetch-service-worker.md · canonical: https://synapse-homepage.web.app/docs/custom-fetch-service-worker · part of https://synapse-homepage.web.app/llms-full.txt -->
